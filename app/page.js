...
export default function Home() {
  return (
    <section className="relative z-10 flex flex-col h-screen gap-4 p-10">
      <h1 className="relative z-10 text-6xl text-center text-naranja-halloween drop-shadow-lg md:text-7xl md:text-left md:w-3/4">¡Bienvenido a Rincón Espeluznante!</h1>
